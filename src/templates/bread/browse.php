    ...
    <div id="content" class="w-full">
        ...
        <div class="px-4 md:px-8 lg:px-10 py-3 md:py-4 lg:py-6">
            <div class="md:flex items-center justify-between mb-6">
                ...
                <a fire href="<?= admin_url('model/' . $model->name() . '/add') ?>" class="inline-flex items-center bg-zinc-800 hover:bg-zinc-700 transition uppercase text-xs px-3 py-1 rounded-full text-slate-50 gap-2">
                    <?= __('Add ' . $model->name()) ?>
...
<?php $this->remove('model', 'query', 'filters', 'where', 'paginator', 'hasRealObjs') ?>