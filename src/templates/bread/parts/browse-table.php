...
if (!function_exists('parseBrowseFieldValue')) {
    ...
    {
        return is_bool($input) ? __($input ? 'Yes' : 'No') : (is_array($input) ? json_encode($input) : $input);
    }
}
?>
                            ...
                            <?php if ($canOrder) : ?>
                                ...
                                <?php if ($orderP) : ?>
                                    <span class="flex items-center">
                                        ...
                                        <svg class="fill-current opacity-75" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
