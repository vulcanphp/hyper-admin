...
<head>
    ...
    <style type="text/css">
        <?= admin()->deque('css') ?>#fire-error-content {
            max-width: 450px;
            margin: 45px auto;
            text-align: center;
        }
...
<body class="bg-zinc-900 min-h-screen text-slate-100">
    ...
    <main fire="content" id="fire-main-content">
        <?= $content ?>
    </main>

    <div id="fire-error-content" style="display: none;">
        <svg xmlns="http://www.w3.org/2000/svg" style="margin: auto;color: #f59e0b;" width="48" height="48" viewBox="0 0 24 24" fill="currentColor">
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            window.fireView.on('beforeLoad', () => {
                document.getElementById('fire-main-content').style.display = 'block';
            ...
            window.fireView.on('onError', () => {
                document.getElementById('fire-main-content').style.display = 'none';
